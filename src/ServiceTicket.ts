...
export class ServiceTicket {
  ...
  public createProcess(process: SpinalProcess): Promise<string> {
  ...
  public createTicket(elementInfo: TicketInterface, infoNode?: any): string {
  ...
  public getCategoriesFromProcess(processId: string)
          ...
          return SpinalGraphService.getChildren(sectionId, [])
            .then(
              (children) => {
                ...
                return res.reduce((acc, elem) => { acc.push(...elem); return acc; }, []);
              });
        }
  ...
  public moveTicket(ticketId: string, stepFromId: string, stepToId: string): Promise<void> {
  ...
  private async getCategories(id: string, res: { id: string, children: string[] }[])
    : Promise<{ id: string, children: string[] }[]> {
