...
import { LOGS_EVENTS } from '../old_constants';

export async function moveTicketToStep(
  ticketNode: SpinalNode,
  stepNodeOrigin: SpinalNode,
  stepNodeTarget: SpinalNode,
  ...
  await addLogToTicketNode(
    ...
    LOGS_EVENTS.move,
    undefined,
    stepNodeOrigin.info.id.get(),
    stepNodeTarget.info.id.get()
  );
}
