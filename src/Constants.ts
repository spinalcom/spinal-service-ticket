...
export const SERVICE_TYPE : string = "SpinalSystemService";
...
export const SPINAL_TICKET_SERVICE_ARCHIVE_NAME : string =  "Spinal Service Ticket Archive";
...
export const SPINAL_TICKET_SERVICE_TICKET_ARCHIVE_NAME : string =  "Spinal Service Ticket Archive - Archive Ticket";
...
export const SPINAL_TICKET_SERVICE_STEP_ARCHIVE_NAME : string =  "Spinal Service Ticket Archive - Archive Step";
...
export const SPINAL_TICKET_SERVICE_PROCESS_ARCHIVE_NAME : string =  "Spinal Service Ticket Archive - Archive Process";
