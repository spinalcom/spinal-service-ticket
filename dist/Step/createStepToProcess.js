...
const insertStepNode_1 = require("./insertStepNode");
...
function createStepToProcess(processNode, contextNodeTicket, name, color, order) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        else if (!order || max - order > 1) {
            order = max + 1;
        }
        if (order >= 0 && order <= max) {
            return (0, insertStepNode_1.insertStepNode)(contextNodeTicket, processNode, {
                name,
                color,
                order,
            });
            ...
            return (0, _initializeStepNode_1._initializeStepNode)(name, color, order, processNode, contextNodeTicket);
        }
    });
}
exports.createStepToProcess = createStepToProcess;
//# sourceMappingURL=createStepToProcess.js.map